...
class MainWindow(Gtk.ApplicationWindow):
    ...
    def _build_core_surface(self) -> Gtk.Box:
        ...
        self.wgp_grid.set_size_request(216, -1)
        self.wgp_grid.set_halign(Gtk.Align.START)
